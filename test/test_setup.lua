...
T['invalid'] = new_set({
    parametrize = {
        ...
        { 'window = { highlight = 42 }',          type(defaults.window.highlight) },
        { 'window = { zindex = "foo" }',          type(defaults.window.zindex) },
        { 'window = { preview = "foo" }',         type(defaults.window.preview) },
        ...
        { 'cmd_window = { highlight = 42 }',      type(defaults.cmd_window.highlight) },
        { 'cmd_window = { zindex = "foo" }',      type(defaults.cmd_window.zindex) },
        { 'cmd_window = { xoffset = "foo" }',     type(defaults.cmd_window.xoffset) },
        { 'cmd_window = { yoffset = "foo" }',     type(defaults.cmd_window.yoffset) },
